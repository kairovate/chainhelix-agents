...
export function buildRunWork(): RunWork {
  ...
  const work = makeRunWork("rebalancing");
...
async function main(): Promise<void> {
  ...
  const agentCard = buildAgentCard({ commerceSkills: rails.erc8183, category: "rebalancing" }); // fix 2026-09-05: the work skill on the card
